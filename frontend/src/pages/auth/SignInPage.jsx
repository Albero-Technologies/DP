...
const ROLE_ROUTES = { ADMIN: "/admin/dashboard", TRAINER: "/trainer/dashboard", COUNSELOR: "/counselor/dashboard", STUDENT: "/student/dashboard" };
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <div className="auth-input">
            ...
            <input id="signin-email" name="email" type="email" placeholder="name@company.com"
        ...
        <div style={{ background: "#f8fafc", borderRadius: 8, padding: "12px 14px", fontSize: 12, color: "#6b7280", border: "1px solid #e5e7eb" }}>
          <strong>Admin login:</strong> Use credentials from your <code>.env</code> file (ADMIN_ID / ADMIN_PASSWORD).<br />
          <strong>Others:</strong> Use email &amp; password provided by your Admin.
        </div>

        <p className="auth-footer">
          New student? <Link className="auth-link" to="/signup">Create account</Link>
        </p>
      </form>
    </AuthLayout>
  );
